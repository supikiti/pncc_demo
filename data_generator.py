...
from pncc import *
from utils import calc_feat_dim, spectrogram_from_file, text_to_int_sequence, spectrogram
...
def vis_train_features(index=0):
    ...
    #audio_gen = AudioGenerator(spectrogram=False)
    #audio_gen.load_train_data()
    #vis_pncc_feature = audio_gen.normalize(audio_gen.featurize(vis_audio_path))
    
    print('-'*60)
    print("pncc was loaded")
    print('-'*60)
